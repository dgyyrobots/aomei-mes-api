...
@Schema(description = "管理后台 - 报工审批明细 Excel 导出 Request VO，参数和 FeedbackAuditDetailPageReqVO 是一致的")
@Data
public class FeedbackAuditDetailExportReqVO {

    @Schema(description = "审批主表ID", example = "9100")
    private Long auditId;

    @Schema(description = "审批汇总表ID", example = "9100")
    private Long auditItemId;

    @Schema(description = "报工记录ID", example = "7315")
    ...
    @Schema(description = "产品物料ID", example = "3281")
    private Long itemId;
